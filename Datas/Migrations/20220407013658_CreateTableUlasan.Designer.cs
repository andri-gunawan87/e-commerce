...
namespace e_commerce.Datas.Migrations
{
    ...
    [Migration("20220407013658_CreateTableUlasan")]
    partial class CreateTableUlasan
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("e_commerce.Datas.Entities.DetailOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("e_commerce.Datas.Entities.Ulasan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("e_commerce.Datas.Entities.DetailOrder", b =>
                {
                    b.HasOne("e_commerce.Datas.Entities.Order", "Order")
            ...
            modelBuilder.Entity("e_commerce.Datas.Entities.Ulasan", b =>
                {
                    b.HasOne("e_commerce.Datas.Entities.Customer", "Customer")
                        .WithMany("Ulasans")
                        .HasForeignKey("IdCustomer")
                        .IsRequired()
